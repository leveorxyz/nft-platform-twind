...
const ExploreCard = ({
  ...
  return (
    <motion.div
      ...
      className="dark:bg-brand-900 dark:border-brand-700 border-brand-200 rounded-lg border bg-white p-[1.1875rem] transition-shadow hover:shadow-lg cursor-pointer"
    >
